 ...
 *   <li>{@link anchor.impl.DataTypeImpl#getModel <em>Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataTypeImpl extends MinimalEObjectImpl.Container implements DataType {
	...
	public Model getModel() {
		if (eContainerFeatureID() != AnchorPackage.DATA_TYPE__MODEL) return null;
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AnchorPackage.DATA_TYPE__MODEL:
				return eInternalContainer().eInverseRemove(this, AnchorPackage.MODEL__DATA_TYPES, Model.class, msgs);
		}
