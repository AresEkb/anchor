...
public class AnchorPackageImpl extends EPackageImpl implements AnchorPackage {
	 ...
	 * @generated
	 */
	public EReference getHistorized_DateTimeType() {
		return (EReference)historizedEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAnchor_Model() {
	 ...
	 * @generated
	 */
	public EReference getKnot_Model() {
		return (EReference)knotEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTie_Model() {
    ...
    public EReference getTie_AnchorRoles() {
		return (EReference)tieEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDateTimeType_MaxInclusive() {
	 ...
	 * @generated
	 */
	public EAttribute getDateTimeType_MaxExclusive() {
	 ...
	 * @generated
	 */
	public EAttribute getDateTimeType_MaxUnit() {
    ...
    public void createPackageContents() {
		...
		createEReference(historizedEClass, HISTORIZED__DATE_TIME_TYPE);
		...
		createEReference(anchorEClass, ANCHOR__MODEL);
		createEReference(anchorEClass, ANCHOR__ATTRIBUTES);

		knotEClass = createEClass(KNOT);
		createEReference(knotEClass, KNOT__MODEL);
		...
		createEReference(tieEClass, TIE__MODEL);
		...
		createEAttribute(dateTimeTypeEClass, DATE_TIME_TYPE__MAX_INCLUSIVE);
		createEAttribute(dateTimeTypeEClass, DATE_TIME_TYPE__MAX_EXCLUSIVE);
		createEAttribute(dateTimeTypeEClass, DATE_TIME_TYPE__MAX_UNIT);
    ...
    public void initializePackageContents() {
		...
		initEReference(getHistorized_DateTimeType(), this.getDateTimeType(), null, "dateTimeType", null, 0, 1, Historized.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(modelEClass, Model.class, "Model", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModel_Anchors(), this.getAnchor(), this.getAnchor_Model(), "anchors", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Knots(), this.getKnot(), this.getKnot_Model(), "knots", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Ties(), this.getTie(), this.getTie_Model(), "ties", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNumericType_MinInclusive(), ecorePackage.getEDoubleObject(), "minInclusive", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumericType_MinExclusive(), ecorePackage.getEDoubleObject(), "minExclusive", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumericType_MaxInclusive(), ecorePackage.getEDoubleObject(), "maxInclusive", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumericType_MaxExclusive(), ecorePackage.getEDoubleObject(), "maxExclusive", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumericType_TotalDigits(), ecorePackage.getEShortObject(), "totalDigits", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumericType_FractionDigits(), ecorePackage.getEShortObject(), "fractionDigits", null, 0, 1, NumericType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDateTimeType_Resolution(), ecorePackage.getEDoubleObject(), "resolution", null, 1, 1, DateTimeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDateTimeType_MaxInclusive(), ecorePackage.getEDoubleObject(), "maxInclusive", null, 0, 1, DateTimeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDateTimeType_MaxExclusive(), ecorePackage.getEDoubleObject(), "maxExclusive", null, 0, 1, DateTimeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDateTimeType_MaxUnit(), this.getUnitOfTime(), "maxUnit", null, 1, 1, DateTimeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
