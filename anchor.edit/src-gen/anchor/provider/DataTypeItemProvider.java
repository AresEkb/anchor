	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_model_feature", "_UI_DataType_type"),
				 AnchorPackage.Literals.DATA_TYPE__MODEL,
				 true,
				 false,
				 true,
				 null,
